...
The code generates two columns providing eight attributes of the simulation, including the behaviours yielding the highest payoffs, given the diet choice. We can look at the values by printing the `data.frame`.
