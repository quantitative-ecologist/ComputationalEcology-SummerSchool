...
We first do posterior predictive checks

```{r eval = FALSE}

# Compute the posterior predictive plots -----------------------------------------
...
# Save the figures
saveRDS(fig1, file = file.path(getwd(), "plots", "fig1.rds"))
saveRDS(fig2, file = file.path(getwd(), "plots", "fig2.rds"))

```

Posterior predictive plots for model 1
```{r out.width="100%", out.height="70%"}
fig1 <- readRDS(file.path(getwd(), "plots", "fig1.rds"))
fig1

```

Posterior predictive plots for model 2
```{r out.width="100%", out.height="70%"}
fig2 <- readRDS(file.path(getwd(), "plots", "fig2.rds"))
fig2
